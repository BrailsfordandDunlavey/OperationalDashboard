	...
	?>
	 <div class="user-table-row">
        ...
        <div class="user-table-user-info">
        		...
        		<h3><a href="<?php bloginfo('siteurl'); ?>/?p_action=user_profile&post_author=<?php echo $uid; ?>"><?php echo get_user_meta($uid, 'rpr_company_name', true); ?></a></h3>
        		<!-- <h3><a href="<?php bloginfo('siteurl'); ?>/members/<?php echo $author_info->user_login; ?>/profile/"><?php echo get_user_meta($uid, 'rpr_company_name', true); ?></a></h3> -->
            	...
            	<ul>
                	<li><a class="avatar-posted-by-username" href="<?php bloginfo('siteurl'); ?>/?p_action=user_profile&post_author=<?php echo $uid; ?>"><?php echo $author_info->rpr_company_name?></a></li>
	...
	?>
        ...
        <div class="post" id="post-<?php the_ID(); ?>"><div class="padd10">
            ...
            <div class="user-poster-thing">
                ...
                <div class="post-main-details">
            	<ul>
                	<li><a class="avatar-posted-by-username" href="<?php bloginfo('siteurl'); ?>/?p_action=user_profile&post_author=<?php echo $post->post_author; ?>"><?php echo $auth->rpr_company_name ?></a></li>
        ...
        <div class="post" id="post-<?php the_ID(); ?>"><div class="padd10">
    		...
    		<div class="post-main-details">
            	<ul>
                	...
                	<li>
                    	<p><i class="budget-icon-me"></i></p>
                        <h4><?php echo sprintf(__('Budget: %s','ProjectTheme'), ProjectTheme_average_bid($pid)) ?></h4>
                    </li>
            ...
            <div class="excerpt-thing">
                ...
                <div class="my-deliv_2">
				  ...
				  { ?> 
                   ...
                   <?php if($closed == "1") //$closed == 1) 
				  { ?>
                  <a href="<?php bloginfo('siteurl') ?>/?p_action=repost_project&pid=<?php the_ID(); ?>" class="green_btn3"><?php echo __("Repost Request", "ProjectTheme");?></a>

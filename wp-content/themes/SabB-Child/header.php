...
?>
	...
	<div id="wrapper">
			...
			<div class="top-bar-bg">
				<div class="top-bar wrapper"> 
                	...
                	<div class="my-logo">
						...
						?>
						<a href="<?php bloginfo('siteurl')?>/index.php/dashboard"><img id="logo" alt="<?php bloginfo('name'); ?>" <?php echo $logo_options; ?> src="<?php echo $logo; ?>" /></a>
                    ...
                    <div class="top-links" id="cssmenu">	<ul>						
                            ...
                            <!-- <li>  
                            <a href="<?php echo get_admin_url(); ?>"><i class="admin-control" ></i> <?php echo __("WP-Admin",'ProjectTheme'); ?></a> </li> -->
                            <?php }
                           ...
                           <li> <a href="<?php echo projectTheme_advanced_search_link2(); ?>"><?php echo __("Advanced Search",'ProjectTheme'); ?></a> </li>
							...
							<?php 
								...
								if(is_user_logged_in())
								{
									...
									?>
									<li><a href="/index.php/watchlist/"><i class="login-awsome" ></i><?php echo __("Watchlist",'ProjectTheme'); ?></a></li>
							...
							<li><a href="<?php bloginfo('siteurl') ?>/index.php/register"><i class="register-awsome" ></i><?php echo __("Register",'ProjectTheme'); ?></a></li>
        ...
        <div class="main_area_homepg">
       		<div class="main_tagLine"><?php _e('Welcome to B2B Connector','ProjectTheme') ?><br />
       		<!--BillyB changed language from "Connecting the world.  Business 2 Business" to "Connecting Local Business"-->
			<?php _e('Connecting Local Business','ProjectTheme') ?></div>
			<!--BillyB changed language from "You can start by posting a chor you need done or register to get your job." to "Where Small Businesses help each other grow"-->
            <div class="sub_tagLine"><div class="wrps"><?php _e('Where Small Businesses help each other grow','ProjectTheme') ?></div></div>
       	 	
            <!-- BillyB hide search functionality from home page
            ...
            <div class="search_box_main">
            	<div class="search_box_main2">
                    <div class="rama1"><input type="text" placeholder="" id="findService" name="term"></div>
                    <div class="rama1 rama2"><input type="image" src="<?php bloginfo('template_url') ?>/images/sear1.png" width="44" height="44" /></div>
                </div>
            </div> BillyB end hide search functionality from homepage-->
            </form>
        	
            <div class="buttons_box_main">
            	<ul class="regular_ul">
                	<!-- <li><a href="<?php echo projectTheme_post_new_link(); ?>"><?php _e('Members Login','ProjectTheme') ?></a></li> -->
                	<!--BillyB Edit languate from "Members Login" to "Existing Members, Login"-->
					<li><a href="<?php bloginfo('siteurl') ?>/wp-login.php"><?php _e('Existing Members, Login','ProjectTheme') ?></a></li>
                	<!-- <li><a href="<?php bloginfo('siteurl') ?>/wp-login.php?action=register"><?php _e("New Business, Register", 'ProjectTheme' ) ?></a></li> -->
                	<!--BillyB Edit language from "Guests" to "New Members"-->
					<li><a href="<?php bloginfo('siteurl') ?>/index.php/register"><?php _e("New Members, Register", 'ProjectTheme' ) ?></a></li>
                </ul>
		...
		//BillyB add if statement to hide menu if not logged in
		if(is_user_logged_in()):{
			$ProjectTheme_show_blue_menu = get_option('ProjectTheme_show_blue_menu');

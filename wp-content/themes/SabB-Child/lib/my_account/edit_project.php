<?php
	...
	function ProjectTheme_filter_ttl($title){return __("Edit Request",'ProjectTheme')." - ";}
...
?>
                ...
                <div class="page_heading_me">
                        <div class="page_heading_me_inner">
                            <div class="mm_inn"><?php printf(__("Edit Request - %s", 'ProjectTheme'), $post->post_title); ?>   </div>                                       
                        </div>                  
                </div>
...
myDropzone.on("removedfile", function(file, response) {
	...
	<?php _e('Click on the area below to add files. Images are not permitted.','ProjectTheme') ?>
    <div class="dropzone dropzone-previews" id="myDropzoneElement" ></div>
	  ...
	  ?>
        ...
        <?php _e("By clicking this checkbox you hide your project from search engines.", 'ProjectTheme'); ?></p>
        </li>
        <?php endif; ?>
	...
	?> 
        ...
        <li>
        <h2>&nbsp;</h2>
        <p><input type="submit" name="save-project" value="<?php _e("Save Revisions",'ProjectTheme'); ?>" class="submit_bottom" /></p>
        </li>

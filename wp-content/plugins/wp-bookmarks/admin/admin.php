...
class wpb_admin {
	...
	function __construct() {
		...
		/* dESiGNERz-CREW.iNFO for PRO users - Plugin slug and version */
		$this->slug = 'wpb';
		$this->subslug = 'wpb';
		...
		/* dESiGNERz-CREW.iNFO for PRO users - Priority actions */
	...
	function save() {
		...
		/* dESiGNERz-CREW.iNFO for PRO users - other post fields */

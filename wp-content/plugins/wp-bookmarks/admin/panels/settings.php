...
<table class="form-table">
	...
	<tr valign="top">
		<th scope="row"><label for="wpb_show_users_avatar"><?php _e('Display avatar of the user who has bookmarked the post','userpro-fav'); ?></label></th>
		<td>
			<select name="wpb_show_users_avatar" id="wpb_show_users_avatar" class="chosen-select" style="width:300px">
				<option value="1" <?php selected('1', wpb_get_option('wpb_show_users_avatar')); ?>><?php _e('Yes','userpro-fav'); ?></option>
				<option value="0" <?php selected('0', wpb_get_option('wpb_show_users_avatar')); ?>><?php _e('No','userpro-fav'); ?></option>
			</select>
		</td>
	</tr>
